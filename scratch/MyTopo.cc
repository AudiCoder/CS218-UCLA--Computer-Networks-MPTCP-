...
int main(int argc, char *argv[])
{
	...
	double packetLossRatio = 0.1;
         double min = 17.026 + 96 - floor(10 *(1-packetLossRatio));
         double max = 17.026 + 96 + ceil(10 *packetLossRatio);
 ...
 InternetStackHelper stack;
  ...
  ipv4Ints.insert(ipv4Ints.end(), p2pinterfaces);

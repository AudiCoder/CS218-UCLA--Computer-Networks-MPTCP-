...
static const uint32_t recvBufSize  = 14000; //2000000;
static uint32_t currentTxBytes     = 0;
static const double simDuration    = 5;
...
double min = 105;
double max = 115;
Ptr<SequentialRandomVariable> x = CreateObject<SequentialRandomVariable>();
...
///////////////////////
    ...
    for(int i=0; i < sf; i++)
			{
				...
				wifiChannel.AddPropagationLoss ("ns3::RandomPropagationLossModel", "Variable", PointerValue(x));
  ...
  mobility.Install (nodes); 
    ...
    Simulator::Stop (Seconds(simDuration+10));
...
//cout<<"calling send@"<<Simulator::Now ().GetSeconds ()<<"===================";
    Simulator::Schedule (Seconds (1.0), &WriteUntilBufferFull, lSocket, 0);
//cout<<"calling close@"<<Simulator::Now ().GetSeconds ()<<"===================";
Simulator::Schedule (Seconds (simDuration), &CloseConnection, lSocket);
//cout<<"called close@"<<"		"<<Simulator::Now ().GetSeconds ()<<"===================";
